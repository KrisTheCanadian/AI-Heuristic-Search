...
{
    private HeuristicContext HeuristicContext { get; set; }
    ...
    public List<Puzzle> Search(Puzzle puzzle)
    {
        ...
        frontier.Enqueue(puzzle, HeuristicContext.GetHeuristicValue(puzzle));
        ...
        while (frontier.Count > 0)
        {
            ...
            foreach (var child in children)
            {
                ...
                frontier.Enqueue(child, newCost + HeuristicContext.GetHeuristicValue(child));
